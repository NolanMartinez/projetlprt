...
<body >
    ...
    <script>
        function no_reset_function(){
            document.cookie = "reset= 1;";
        }
    </script>
    <?php
        ...
        $date = date("Y-m-j G:i:s");
            if ($id_cap and $latitude and $longitude and $reset == 1){
    ...
    <div class="corp">
        <form method="post" id="info">
            ...
            <div class="zone_button">
                <input type="submit" value="Ajouter" id="envoie" onclick="no_reset_function()">
